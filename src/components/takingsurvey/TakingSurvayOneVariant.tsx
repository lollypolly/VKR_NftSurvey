...
function TakingSurveyOneVariant({text,answersVatiant}:any,{exportCallback}:any) {
    ...
    console.log("Stor in Survy",store)
    console.log("event-target-name",ev)
    return (
        <>
                ...
                {answersVatiant.map((item:any,index:any)=>
                    <div className="radio-buttons-group">
                        <div className="radio-button-answer">
                            <input type="radio" id={index} name={text} value={index} onChange={handleQuestions} />
...
export default TakingSurveyOneVariant;
