...
import { getUserInfo } from "../scripts/web3";
    ...
    return (
        <div className="profile-main">
            ...
            <div className="profile">
                ...
                <div className="my-profile-text">Вы приобрели NFT токен, теперь вы можете участвовать и создавать опросы</div>
                ...
                <div className="experience">
                   ...
                   {(userData?.gender === "1")? (<div className="experience-right-side">Женщина</div>):
                     <div className="experience-right-side">Мужчина</div>}

                </div>
                <div className="experience">
                    <div className="experience-left-side">Почта</div>
                    <div className="experience-right-side">{userData?.email.slice(0,7)}</div>
                </div>
                <div className="experience">
                ...
                <div style={{marginTop:"36px", width:"100%"}}>
                    <Button500 buttonInner="Изменить данные профиля" defaultClass="button-500" func={updatedUserData}/>
                </div>
            </div>
